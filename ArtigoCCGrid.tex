...
\begin{figure}[!t]
	\centering
	\includegraphics[scale=0.3]{NovaFigura_Algoritmo.pdf} 
...
\WHILE{there is data}
	\IF {processorIdle()}
		\STATE $finishTimes$  = distributeTasks(X);
	\ENDIF	
...
execution. In this example, the three machines were running a graphical application on the GPU,
 and at the time 400 ms  was canceled the graphical application on machine C, 
causing rebalancing.
