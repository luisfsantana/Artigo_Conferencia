...
GPUs. To use these heterogeneous devices in an efficient manner, it is necessary
to balance the computational load among the GPUs and CPUs according to the
tasks' sizes, minimizing the execution time of the application.
