...
% RYC1029: Luis -> colocar referências mais recentes. -> Alguém parece que atualizou deste parágrafo (LFS)
...
% de sincronização?
%Nao existe barreira de sincronizaçao nos algoritmos, por isso a comparacao é justa. O que pode ocorrer sincronizacão é o nosso, mas aqui eu tirei o teste de sincronizacao.
...
%Eu rodei mais de uma vez para analisar os resultados e parece mesmo que para redes menores o ganho é maior. Eu notei que com redes grandes, há muita comunicacao, diferente das redes pequenas, entao se copia da memoria da GPU para CPU os resultados e transfere, algumas vezes para redes grandes. Entao as minhas ideias para o ganho ser maior com pequenas é a diminuição de cópias GPU/CPU, menor tráfico na rede e diminuição de sincronizações.
...
%Tentei fazer a anlise independente das tarefas, apenas somei a quantidade de dados de cada tarefa.
