...
x 4096 to 65536 x 65536 elements, and with different number of machines. With
...
% RYC: Luis, veja se o parágrafo está certo, pois eu alterei seu conteúdo
%
...
point method. The mean time spent on this calculation was 664.9 ms, with
...
\begin{figure}[htb]
	...
	\end{center}
\end{figure}
% RYC: cada figura com os tempos finais das threads está com um tamanho diferente
% RYC: retirar os títulos dos gráficos
...
% algoritmos? Nestes casos, não seria melhor medir os atrasos em cada barreira
% de sincronização?
...
% RYC: Por que é vantajoso para o HDSS diminuir o tamanho das tarefas? Explicar no texto.
