...
equlibrium is achieved asymptotically, as the definition of the load on each
...
several iterations, resulting in poor peformance and the need for several
...
accurracy, preventing these unnecessary rebalancing.
...
\begin{figure}[!t]
	\centering
			\includegraphics[scale=0.3]{CPUVersusGPULinear2_Ajustado.pdf} 				
...
same scenario. Our algorithm have the smallest amount of difference among all
