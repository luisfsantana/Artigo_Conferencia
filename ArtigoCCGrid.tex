...
algorithms: (1) our algorithm, (2) static, (3) HDSS, and (4) Greedy. Our algorithm was configured with a threshold of 10\% of the execution time and initial block size of 2048 elements. The initial block size of HDSS algorithm was 1024 elements.
...
to see that the proposed algorithm perform better than the other algorithm under
all scenarios.
...
\IEEEtriggeratref{14}  % REAJUSTAR DEPOIS DE TODAS AS MODIFICACOES!
