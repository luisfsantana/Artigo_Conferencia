...
\begin{figure*}[htb]
	\begin{center}
	\centering
		\subfigure[1 machine]{\includegraphics[height=3.3cm, width=4.52cm]{1machineN.pdf}}
	        \subfigure[2 machine]{\includegraphics[height=3.3cm, width=4.52cm]{2machineN.pdf}}
		\subfigure[3 machine]{\includegraphics[height=3.3cm, width=4.52cm]{3machineN.pdf}}
		\subfigure[4 machine]{\includegraphics[height=3.3cm, width=4.52cm]{4machineN.pdf}}
...
\begin{figure*}[htb]
	...
	\centering
		...
		\subfigure[1 machine]{\includegraphics[height=3.3cm, width=4.52cm]{1machineBlackN.pdf}}
	        \subfigure[2 machine]{\includegraphics[height=3.3cm, width=4.52cm]{2machineBlackN.pdf}}
		\subfigure[3 machine]{\includegraphics[height=3.3cm, width=4.52cm]{3machineBlackN.pdf}}
		\subfigure[4 machine]{\includegraphics[height=3.3cm, width=4.52cm]{4machineBlackN.pdf}}
...
\begin{figure*}[htb]
	...
	\centering
		...
		\subfigure[1 machine]{\includegraphics[height=3.3cm, width=4.52cm]{1machineGeneN.pdf}}
	        \subfigure[2 machine]{\includegraphics[height=3.3cm, width=4.52cm]{2machineGeneN.pdf}}
		\subfigure[3 machine]{\includegraphics[height=3.3cm, width=4.52cm]{3machineGeneN.pdf}}
		\subfigure[4 machine]{\includegraphics[height=3.3cm, width=4.52cm]{4machineGeneN.pdf}}
